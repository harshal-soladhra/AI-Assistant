        ...
        <div className="footer-top">
          <div className="footer-column footer-brand">
            <div className="footer-logo">
              <svg className="logo-icon" viewBox="0 0 24 24" fill="none">
                <path d="M12 2L2 7L12 12L22 7L12 2Z" fill="url(#footerGradient1)"/>
                <path d="M2 17L12 22L22 17V11L12 16L2 11V17Z" fill="url(#footerGradient2)"/>
                <defs>
                  <linearGradient id="footerGradient1" x1="2" y1="2" x2="22" y2="12">
                    <stop offset="0%" stopColor="#00F5FF"/>
                    <stop offset="100%" stopColor="#0066FF"/>
                  </linearGradient>
                  <linearGradient id="footerGradient2" x1="2" y1="11" x2="22" y2="22">
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/service">Data Science</Link></li>
